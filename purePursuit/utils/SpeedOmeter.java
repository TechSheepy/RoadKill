...
public class SpeedOmeter {
    ...
    public static void update(){
        ...
        if(currTime - lastUpdateStartTime > timeBetweenUpdates){
            ...
            angularVelocity = AngleWrap(RobotGlobalVars.ReadPosValuesAccumulatedAngle().getHeading()-lastAngle) / elapsedTime;
            lastAngle = RobotGlobalVars.ReadPosValuesAccumulatedAngle().getHeading();
    ...
    public static double getSpeedY(){
        return RobotGlobalVars.ReadSpeedValues().getY();
    }
    /**gets relative x speed = cm/s*/
    public static double getSpeedX(){
        return RobotGlobalVars.ReadSpeedValues().getX();
    }

    public static double getDegPerSecond() {
        return Math.toDegrees(RobotGlobalVars.ReadSpeedValues().getHeading());
    }
    public static double getRadPerSecond(){
        return RobotGlobalVars.ReadSpeedValues().getHeading();
    }
